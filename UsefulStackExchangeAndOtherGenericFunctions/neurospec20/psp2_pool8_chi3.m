function psp2_pool8_chi3(f,cl,freq,ch_max,chi_max,label)
% psp2_pool8_chi3(f,cl,freq,ch_max,chi_max,label)
...
%
% This 8 plot version, 3 chi-squared tests, no time domain plot.
%
% psp2_pool8_chi3(f,cl,freq,ch_max,chi_max,label)
