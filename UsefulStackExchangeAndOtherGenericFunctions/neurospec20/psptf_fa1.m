function psptf_fa1(f,cl,freq,t_inc,n_contour,colorbar_flag,line_flag)
% function psptf_fa1(f,cl,freq,t_inc,n_contour,colorbar_flag,line_flag)
...
% Plot Time dependent log spectra of channel 1.
[C,h]=contourf(squeeze(f(1:freq_pts,2,1:n_seg)),n_contour);
if (line_flag==0)
  for ind=1:length(h)
