function psp_q1(t,cl,lag_tot,lag_neg,label)
% psp_q1(t,cl,lag_tot,lag_neg,label)
% function to plot cumulant density in current figure/subplot window
%
...
q_ucl=[-lag_neg,cl.q_c95;lag_tot-lag_neg,cl.q_c95];
q_lcl=[-lag_neg,-cl.q_c95;lag_tot-lag_neg,-cl.q_c95];
plot(t(bin_start:bin_stop,1),t(bin_start:bin_stop,2),'k-',q_zl(:,1),q_zl(:,2),'k--',q_ucl(:,1),q_ucl(:,2),'k-',q_lcl(:,1),q_lcl(:,2),'k-');
