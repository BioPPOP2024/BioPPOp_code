function psp_fchib1(f,cl,freq,chi_max,label)
% psp_fchib1(f,cl,freq,chi_max,label)
% function to plot chi^2 test variate in current figure/subplot window
% This version plots estimate in column 10 of f matrix: Test for output spectra
%
...
plot(f(1:freq_pts,1),f(1:freq_pts,10),'k-',chi_cl(:,1),chi_cl(:,2),'k--');
if (nargin<4)
  chi_max=0;
end
if (chi_max==0)
