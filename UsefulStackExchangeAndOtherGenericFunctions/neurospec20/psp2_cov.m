function psp2_cov(f,t,cl,freq,lag_tot,lag_neg,ch_max,label)
% psp2_cov(f,t,cl,freq,lag_tot,lag_neg,ch_max,label)
% Function to plot output of 2 channel spectral analysis, 
%  from type 0, type 1 or single offset type 2.
% Includes optional Periodogram COV test for each channel.
%
...
if (nargin<8)
  ...
  psp_fb1(f,cl,freq)
  subplot(4,2,3)
  psp_fcova1(f,cl,freq)
  subplot(4,2,4)
  psp_fcovb1(f,cl,freq)
  subplot(4,2,5)
