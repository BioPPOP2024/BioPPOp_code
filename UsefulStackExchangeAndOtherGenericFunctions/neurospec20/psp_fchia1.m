function psp_fchia1(f,cl,freq,chi_max,label)
% psp_fchia1(f,cl,freq,chi_max,label)
% function to plot chi^2 test variate in current figure/subplot window
% This version plots estimate in column 9 of f matrix: Test for input spectra
%
...
plot(f(1:freq_pts,1),f(1:freq_pts,9),'k-',chi_cl(:,1),chi_cl(:,2),'k--');
if (nargin<4)
  chi_max=0;
end
if (chi_max==0)
