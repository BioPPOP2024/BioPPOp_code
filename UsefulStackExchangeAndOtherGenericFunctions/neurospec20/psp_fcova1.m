function psp_fcova1(f,cl,freq,label)
% psp_fcova1(f,cl,freq,label)
...
f_max=f(freq_pts,1);
  ...
  f_cl=[cl.df,1;f_max,1;
        ...
        cl.df,1-cl.cov_c95;f_max,1-cl.cov_c95];
  plot(f(1:freq_pts,1),f(1:freq_pts,cl.col_cova),'k-',f_cl(1:2,1),f_cl(1:2,2),'k--',f_cl(3:4,1),f_cl(3:4,2),'k-',f_cl(5:6,1),f_cl(5:6,2),'k-');
  axis([0,freq,-Inf,Inf]);
