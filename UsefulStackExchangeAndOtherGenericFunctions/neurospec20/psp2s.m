function psp2s(f,t,cl,freq,lag_tot,lag_neg,ch_max,label)
% psp2s(f,t,cl,freq,lag_tot,lag_neg,ch_max,label)
% Function to plot output of 2 channel spectral analysis,
%  from type 0, type 1 or single offset type 2.
% Includes optional system identication parameter estimates:  Gain and Impulse response.
%
