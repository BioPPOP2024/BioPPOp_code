function psptf_ch1(f,cl,freq,t_inc,n_contour,colorbar_flag,line_flag,coh_contour)
% function psptf_ch1(f,cl,freq,t_inc,n_contour,colorbar_flag,line_flag,coh_contour)
...
[C,h]=contourf(squeeze(f(1:freq_pts,4,1:n_seg)),coh_contour);
H1=gca;
if (line_flag==0)
  for ind=1:length(h)
