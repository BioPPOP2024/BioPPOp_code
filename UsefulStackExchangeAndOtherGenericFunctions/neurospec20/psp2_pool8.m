function psp2_pool8(f,t,cl,freq,lag_tot,lag_neg,ch_max,chi_max,label)
% psp2_pool8(f,t,cl,freq,lag_tot,lag_neg,ch_max,chi_max,label)
% function to plot output of 2 channel pooled spectral analysis (8 panel figure).
%
...
if (nargin<9)
  ...
  subplot(4,2,4)
  psp_ph1(f,cl,freq)
  % Pooled (f) coherence, in column 6 of f.
  subplot(4,2,5)
  psp_chplf1(f,cl,freq,ch_max)
  % Chi^2 test, in column 8.
  subplot(4,2,6)
