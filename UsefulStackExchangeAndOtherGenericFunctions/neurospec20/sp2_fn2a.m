...
f(:,6)=f11(f_index);  f(:,6) = smooth(f(:,6),20); % Column 6 - spectrum ch 1. %ADDED BY KD FOR EFFECT SIZES
f(:,7)=f22(f_index);  f(:,7) = smooth(f(:,7),20); % Column 7 -  spectrum ch 2. %ADDED BY KD FOR EFFECT SIZES
