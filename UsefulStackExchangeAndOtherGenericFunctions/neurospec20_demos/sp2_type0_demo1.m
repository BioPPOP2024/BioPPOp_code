% Script sp2_type0_demo1.m
% Script to demonstrate use of NeuroSpec 2.0
% TYPE 0 spectral analysis and plotting routines.
%
...
%
% Demonstration of TYPE 0 analysis:
%  Analysis using disjoint sections.

%--------------------------------------------------------------------------
% Section 1: Usage of sp2a2_m1.m
...
% No options used here - empty string passed to routine.
opt_str='';

% Process columns 1 and 2, these are Uncorrelated
[f,t,cl]=sp2a2_m1(0,dat(:,1),dat(:,2),samp_rate,seg_pwr,opt_str);
...
[f1,t1,cl1]=sp2a2_m1(0,dat(:,1),dat(:,3),samp_rate,seg_pwr,opt_str);
...
[f2,t2,cl2]=sp2a2_m1(0,dat(:,2),dat(:,4),samp_rate,seg_pwr,opt_str);
...
% Include Periodogram COV test in options string
opt_str='s c';

[f3,t3,cl3]=sp2a2_m1(0,dat(:,1),dat(:,5),samp_rate,seg_pwr,opt_str);
...
% Plots of gain, phase and coherence with pointwise confidence limits
freq=75;
ch_max=0.7;
conf_plot_type=0;
figure
subplot(3,1,1)
psp_g1cl(f3,cl3,freq,conf_plot_type)
axis([0 freq -inf 0])
subplot(3,1,2)
psp_ph1cl(f3,cl3,freq,conf_plot_type)
subplot(3,1,3)
psp_ch1cl(f3,cl3,freq,ch_max,conf_plot_type)

% Plot with psp2_cov, includes Periodogram COV test for each channel.
freq=100;
ch_max=1;
figure
psp2_cov(f3,t3,cl3,freq,lag_tot,lag_neg,ch_max)
...
sp1=sp(1:length(find(sp<100000)));
...
sp2=sp(1:length(find(sp<100000)));
...
opt_str='';    % Clear options
[f4,t4,cl4]=sp2_m1(0,sp1,sp2,sec_tot,samp_rate,seg_pwr,opt_str);
...
% Spike train and time series are independent - show no correlation.

[f5,t5,cl5]=sp2a_m1(0,sp1,dat(:,1),samp_rate,seg_pwr,opt_str);
